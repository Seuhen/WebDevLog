...
**Reflections:**  
Today was all about creating interactive forms that collect user preferences in a fun, fantasy guild setting. I learned how to organize questions using fieldsets, properly label each input, and offer a variety of ways for users to share information—whether via dropdowns, radio buttons, or checkboxes. Giving the survey personality made the coding process more engaging, and I enjoyed the challenge of balancing usability and creativity!
